# This version is a bit different from the original in eval/dataset.py.
# The original one was not compatible with the label assigned to images in
...
def is_label(filename):
    return filename.endswith("_labelIds.png") # Originally it was "_labelTrainIds"
